...
SRC_FILES := cli.c ft_result.c ft_string.c ft_util.c main.c ping_stats.c ft_time.c ft_sqrt.c init.c ft_signal.c get_error.c iter.c packet_util.c misc.c print.c
INC_FILES := cli.h ft_result.h ft_string.h ft_util.h ping_stats.h ft_time.h ft_sqrt.h init.h ft_signal.h posix_setup.h get_error.h iter.h packet_util.h
